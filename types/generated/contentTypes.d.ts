...
export interface ApiAgenteAgente extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::agente.agente', 'agentName'>;
    cargo: Attribute.String;
    telefono: Attribute.String;
    correo: Attribute.String;
    fotoPrincipal: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiCategoriaCategoria extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::categoria.categoria', 'nombreCategoria'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiInmuebleInmueble extends Schema.CollectionType {
  ...
  attributes: {
    inmuebleName: Attribute.String;
    slug: Attribute.UID<'api::inmueble.inmueble', 'inmuebleName'>;
    Direccion: Attribute.Text;
    imagenes: Attribute.Media;
    terreno: Attribute.Float;
    construccion: Attribute.Float;
    dormitorios: Attribute.Integer;
    banos: Attribute.Integer;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::inmueble.inmueble': ApiInmuebleInmueble;
    }
  }
}
